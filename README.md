...
> ⚠️ **Устанавливать можно только пакеты, имеющие исполняемые целевые крейты**
...
### Создание рабочего пространства Cargo
...
### Запуск тестов для конкретного Cargo проекта из рабочего пространства

```bash
cargo test -p add_one
```

### Публикация конкретной библиотеки из рабочего пространства на Crates.io
